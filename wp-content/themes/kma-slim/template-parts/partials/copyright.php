...
<div class="container has-text-centered" tabindex="0">
    <p class="copyright">&copy;<?php echo date('Y'); ?> <?php echo get_bloginfo(); ?>. All&nbsp;Rights&nbsp;Reserved.
        <span>&nbsp;|&nbsp;</span>
        <span><a href="https://pwillys.com/sitemap_index.xml" target="_blank" noreferrer>Site&nbsp;Map</a></span>
        <span class="siteby">
        ...
        </svg> &nbsp;<a href="https://keriganmarketing.com" target="_blank" noreferrer>Site&nbsp;by&nbsp;KMA</a>.
        </span>
    </p>
</div>